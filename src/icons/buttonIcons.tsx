export const DetailsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  ...
  export const EditDrivinglicenseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      width={14}
  ...
  export const DeleteDrivingLicenseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      width={14}
  ...
  export const AddWorkerIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#FFFFFF"} fill={"none"} {...props}>
